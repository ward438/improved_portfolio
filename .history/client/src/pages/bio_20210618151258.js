...
function Bio() {
    return (
        <Card className="text-center" style={{ borderRadius: '15px', marginBottom: '13.6rem' }}>
            <Card.Body>
                <Card.Header>Robert's Portfolio</Card.Header>
                <Card.Img variant="top" style={{ width: '15%', borderRadius: '15px', marginTop: '15px' }} src={`https://react-portfolio-rob.s3.amazonaws.com/131530476_127869602470312_4401820499573357152_n.jpg`}>
                    <p> My development career started January 2021 after enrolling in the UTSA Full Stack Developer Bootcamp. Heavily focused in JavaScript frameworks such as React and Node.</p>
                </Card.Img>
