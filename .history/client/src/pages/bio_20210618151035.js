    ...
    return (
        <Card className="text-center" style={{ borderRadius: '15px', marginBottom: '13.6rem' }}>
            <Card.Body>
                ...
                <Card.Img variant="top" style={{ width: '15%', borderRadius: '15px', padding: '15px' }} src={`https://react-portfolio-rob.s3.amazonaws.com/131530476_127869602470312_4401820499573357152_n.jpg`} />
