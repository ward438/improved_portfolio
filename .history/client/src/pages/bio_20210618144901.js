    ...
    return (
        <Card className="text-center" style={{ borderRadius: '15px' }}>
            <Card.Body>
                ...
                <Card.Img variant="top" style={{ width: 20%', borderRadius: '15px' }} src={`https://react-portfolio-rob.s3.amazonaws.com/131530476_127869602470312_4401820499573357152_n.jpg`} />
            ...
            <Card.Footer className="text-muted" className="techNames">
                ...
                <div>
                    Education: AAS Welding Technology<br />
                    OIF 08-09 Veteran <br /><br />                   
                </div>
            </Card.Footer>
            <div></div>
        </Card>
