    ...
    return (
        <Card className="text-center" style={{ borderRadius: '15px' }}>
            <Card.Body>
                ...
                <Card.Text>
                    My development career started January 2021 after enrolling in the UTSA Full Stack Developer Bootcamp. Heavily focused in JavaScript frameworks such as React and Node. Working knowledge of MySql and NoSql databases.
