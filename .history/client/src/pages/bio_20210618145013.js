    ...
    return (
        <Card className="text-center" style={{ borderRadius: '15px' }}>
            <Card.Body>
                ...
                <Card.Img variant="top" style={{ width: '25%', borderRadius: '15px' }} src={`https://react-portfolio-rob.s3.amazonaws.com/131530476_127869602470312_4401820499573357152_n.jpg`} />
