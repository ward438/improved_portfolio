    ...
    return (
        <Card className="text-center" style={{ borderRadius: '15px' }}>
            ...
            <Card.Body>
                ...
                <Card.Text>
                    Started my development career January of 2021 by enrolling in the UTSA Full Stack Developer Bootcamp. Heavily focused in the JavaScript. Working knowledge of API integration. I have moved from a long career in heavy equipment maintenance and pipe welding.
